...
var React = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var index_1 = __webpack_require__(/*! ./views/index */ "./client/src/pages/ratings-entries/views/index.tsx");
ReactDOM.render(React.createElement(index_1.default, null), document.getElementById("app-rat-entries"));


/***/ }),

/***/ "./client/src/pages/ratings-entries/views/index.tsx":
/*!**********************************************************!*\
  !*** ./client/src/pages/ratings-entries/views/index.tsx ***!
  \**********************************************************/
/*! no static exports found */
...
var MiniModal = function (props) {
    if (!props.isVisible)
        return null;
    return React.createElement(modal_1.default, null,
        React.createElement("div", { style: { width: "300px" } }, "Hi!"),
        React.createElement("button", { onClick: function () { return props.onClose(); } }, "Close"));
};
var RatingEntriesIndex = /** @class */ (function (_super) {
    __extends(RatingEntriesIndex, _super);
    function RatingEntriesIndex(props) {
        var _this = _super.call(this, props) || this;
        _this.showModal = function () { return _this.setState({ showModal: true }); };
        _this.hideModal = function () { return _this.setState({ showModal: false }); };
        _this.changeBusinessDate = function (date) {
            var newBusinessDate = !isNaN(new Date(date).getTime()) ? new Date(date) : null;
            _this.setState({ businessDate: newBusinessDate });
        };
        _this.state = {
            showModal: false,
    ...
    RatingEntriesIndex.prototype.render = function () {
        var _this = this;
        return React.createElement(React.Fragment, null,
            React.createElement(tab_view_1.default, null,
                React.createElement(tab_1.default, { title: "\u0417\u0430\u043F\u0438\u0441\u0438 \u0440\u0435\u0439\u0442\u0438\u043D\u0433\u0456\u0432", label: "ratingEntries" },
                ...
                React.createElement(tab_1.default, { title: "\u0420\u0435\u0439\u0442\u0438\u043D\u0433\u0438 \u0424\u041F\u0423", label: "fpuRatings" },
                    React.createElement("div", null,
                        "234",
                        React.createElement(Datetime, { value: this.state.businessDate, dateFormat: 'DD-MM-YYYY', timeFormat: false, closeOnSelect: true, onChange: function (date) { return _this.changeBusinessDate(date.toString()); } })))),
            React.createElement(MiniModal, { isVisible: this.state.showModal, onClose: this.hideModal }));
    };
    return RatingEntriesIndex;
}(React.Component));
exports.default = RatingEntriesIndex;
