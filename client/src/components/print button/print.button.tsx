...
const PrintButton: React.StatelessComponent<PrintButtonProps> = (props) => {
    return <>
        <span className={classnames("print-button", props.classNames)} onClick={() => onPrint(props.printTargetId)}>
            <FontAwesome name="print" />{props.label}
        </span>
        <iframe id="printing-frame" name="print_frame" src="about:blank" style={{display: 'none' }}></iframe>
    </>
}

function onPrint(elementId: string){
