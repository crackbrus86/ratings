...
export const LOAD_MINISTRY_REGION_RATINGS = "RATINGS::LOAD_MINISTRY_REGION_RATINGS";
export type LOAD_MINISTRY_REGION_RATINGS_PAYLOAD = Models.Rating[];

export const LOAD_MINISTRY_FST_RATINGS = "RATINGS::LOAD_MINISTRY_FST_RATINGS";
export type LOAD_MINISTRY_FST_RATINGS_PAYLOAD = Models.Rating[];

export const LOAD_MINISTRY_SCHOOL_RATINGS = "RATINGS::LOAD_MINISTRY_SCHOOL_RATINGS";
export type LOAD_MINISTRY_SCHOOL_RATINGS_PAYLOAD = Models.Rating[];